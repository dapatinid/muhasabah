...
<template>
    <Head title="Verifikasi Penggalang Dana" />
      ...
      <div v-if="!isSteppingToQuiz" class="bg-stone-900 border border-stone-800 rounded-2xl p-6 sm:p-8 shadow-xl m-3">
        <h1 class="text-xl sm:text-2xl font-bold text-amber-500 mb-4">Verifikasi Ketat Penggalang Dana</h1>
        <p class="text-stone-400 text-sm leading-relaxed mb-6">
          Untuk menjaga transparansi, akuntabilitas, dan mencegah penyalahgunaan dana umat, Anda diwajibkan menyetujui <span class="text-stone-200 font-semibold">200 poin Pakta Integritas</span> secara mutlak.
        </p>
        <button 
...
<style scoped>
/* Menghilangkan scrollbar default pada tabs horizontal agar tetap clean */
