...
import { Clock, HeartHandshake, Ticket, MessageSquare, Heart, Star, UserCheck, Calendar, Wallet } from 'lucide-vue-next'
...
<template>
    <Head title="Aktivitas Saya - Donasi" />
    ...
    <div class="py-10 px-4 w-full max-w-4xl mx-auto font-poppins">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100 flex items-center gap-2">
                <Wallet class="size-6 text-amber-500" />
                Donasi Saya
            </h1>
        ...
        <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl shadow-sm overflow-hidden">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <div class="text-xs text-zinc-400 mt-0.5">
                                Berdonasi ke: <span class="font-medium text-zinc-600 dark:text-zinc-300">{{ log.paymentable?.judul || 'Program Terhapus' }}</span>
                            </div>
            ...
            <div v-else class="py-20 text-center text-zinc-400 text-sm">
                ...
                Belum ada aktivitas donasi yang tercatat pada akun Anda.
            </div>
        </div>
    </div>
</template>