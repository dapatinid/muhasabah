    ...
    <div class="py-10 px-4 w-full mx-auto">
      ...
      <form @submit.prevent="submit">
        ...
        <div class="flex flex-col md:flex-row gap-4 items-center justify-between pt-6">
          ...
          <Button 
            type="submit" 
            class="w-full md:w-auto bg-amber-600 hover:bg-amber-700 text-white px-10 h-12 rounded-xl font-bold gap-2 transition-all"
            :disabled="form.processing"
          >
            <Save class="size-5" />
            {{ form.processing ? 'Menyimpan...' : 'Terbitkan Donasi' }}
          </Button>
        </div>
