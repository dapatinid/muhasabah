...
import { ArrowLeft, Settings, ChevronDown, HeartHandshake, MessageSquare, ArrowDownCircle, ArrowUpCircle, PlusCircle, Inbox, X, Save, Eye, SquarePen, Newspaper } from 'lucide-vue-next'
