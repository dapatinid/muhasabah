...
*/
export const update = (args: { lingkaran: number | { id: number } } | [lingkaran: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'put'> => ({
...
* @route '/admin/lingkaran/{lingkaran}'
*/
update.url = (args: { lingkaran: number | { id: number } } | [lingkaran: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { lingkaran: args }
    }
...
* @route '/admin/lingkaran/{lingkaran}'
*/
update.put = (args: { lingkaran: number | { id: number } } | [lingkaran: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: update.url(args, options),
    method: 'put',
})
...
* @route '/admin/lingkaran/{lingkaran}'
*/
const updateForm = (args: { lingkaran: number | { id: number } } | [lingkaran: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/admin/lingkaran/{lingkaran}'
*/
updateForm.put = (args: { lingkaran: number | { id: number } } | [lingkaran: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: update.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'PUT',
            ...(options?.query ?? options?.mergeQuery ?? {}),
