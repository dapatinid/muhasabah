...
* @see app/Http/Controllers/DonasiController.php:144
* @route '/donasi/{donasi}/payment'
*/
...
const DonasiController = { donasi, payment, storePayment, index, create, store, uploadImage, edit, update, destroy, show }
