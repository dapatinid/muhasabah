...
* @see app/Http/Controllers/AcaraController.php:383
...
* @see app/Http/Controllers/AcaraController.php:394
* @route '/acara/{acara}/payment'
*/
...
* @see app/Http/Controllers/AcaraController.php:329
...
* @see app/Http/Controllers/AcaraController.php:356
...
* @see app/Http/Controllers/AcaraController.php:53
* @route '/admin/acara'
*/
...
* @see app/Http/Controllers/AcaraController.php:80
...
* @see app/Http/Controllers/AcaraController.php:85
* @route '/admin/acara'
*/
...
* @see app/Http/Controllers/AcaraController.php:109
...
* @see app/Http/Controllers/AcaraController.php:124
...
* @see app/Http/Controllers/AcaraController.php:150
...
* @see app/Http/Controllers/AcaraController.php:162
* @route '/admin/acara/{acara}/progress'
*/
...
* @see app/Http/Controllers/AcaraController.php:171
...
* @see app/Http/Controllers/AcaraController.php:189
...
/**
* @see \App\Http\Controllers\AcaraController::transaksiMasuk
* @see app/Http/Controllers/AcaraController.php:207
* @route '/admin/acara/{acara}/transaksi-masuk'
*/
export const transaksiMasuk = (args: { acara: string | { slug: string } } | [acara: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: transaksiMasuk.url(args, options),
    method: 'get',
})

transaksiMasuk.definition = {
    methods: ["get","head"],
    url: '/admin/acara/{acara}/transaksi-masuk',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/admin/acara/{acara}/transaksi-masuk'
*/
transaksiMasuk.url = (args: { acara: string | { slug: string } } | [acara: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { acara: args }
    }
    ...
    return transaksiMasuk.definition.url
            .replace('{acara}', parsedArgs.acara.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/admin/acara/{acara}/transaksi-masuk'
*/
transaksiMasuk.get = (args: { acara: string | { slug: string } } | [acara: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: transaksiMasuk.url(args, options),
    method: 'get',
})
...
* @route '/admin/acara/{acara}/transaksi-masuk'
*/
transaksiMasuk.head = (args: { acara: string | { slug: string } } | [acara: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: transaksiMasuk.url(args, options),
    method: 'head',
})
...
* @route '/admin/acara/{acara}/transaksi-masuk'
*/
const transaksiMasukForm = (args: { acara: string | { slug: string } } | [acara: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: transaksiMasuk.url(args, options),
    method: 'get',
})
...
* @route '/admin/acara/{acara}/transaksi-masuk'
*/
transaksiMasukForm.get = (args: { acara: string | { slug: string } } | [acara: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: transaksiMasuk.url(args, options),
    method: 'get',
})
...
* @route '/admin/acara/{acara}/transaksi-masuk'
*/
transaksiMasukForm.head = (args: { acara: string | { slug: string } } | [acara: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: transaksiMasuk.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
transaksiMasuk.form = transaksiMasukForm

/**
* @see \App\Http\Controllers\AcaraController::tasyaruf
* @see app/Http/Controllers/AcaraController.php:234
* @route '/admin/acara/{acara}/tasyaruf'
*/
export const tasyaruf = (args: { acara: string | { slug: string } } | [acara: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/admin/acara/{acara}/tasyaruf'
*/
tasyaruf.url = (args: { acara: string | { slug: string } } | [acara: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { acara: args }
    }
...
* @route '/admin/acara/{acara}/tasyaruf'
*/
tasyaruf.get = (args: { acara: string | { slug: string } } | [acara: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: tasyaruf.url(args, options),
    method: 'get',
})
...
* @route '/admin/acara/{acara}/tasyaruf'
*/
tasyaruf.head = (args: { acara: string | { slug: string } } | [acara: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: tasyaruf.url(args, options),
    method: 'head',
})
...
* @route '/admin/acara/{acara}/tasyaruf'
*/
const tasyarufForm = (args: { acara: string | { slug: string } } | [acara: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/admin/acara/{acara}/tasyaruf'
*/
tasyarufForm.get = (args: { acara: string | { slug: string } } | [acara: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: tasyaruf.url(args, options),
    method: 'get',
})
...
* @route '/admin/acara/{acara}/tasyaruf'
*/
tasyarufForm.head = (args: { acara: string | { slug: string } } | [acara: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @see app/Http/Controllers/AcaraController.php:249
* @route '/admin/acara/{acara}/tasyaruf'
*/
...
* @see app/Http/Controllers/AcaraController.php:377
* @route '/admin/acara/{acara}'
*/
...
* @see app/Http/Controllers/AcaraController.php:295
* @route '/acara/{acara}'
*/
...
const AcaraController = { acara, payment, storePayment, storeKomentar, storeReaksi, index, create, store, edit, update, progress, updateProgress, reaksi, komentar, transaksiMasuk, tasyaruf, storeTasyaruf, destroy, show }
